...
<p>
  ⚙️ Building low-level software and developer tools<br>
  🚀 Focusing on performance, architecture, and systems development<br>
  🧩 Working on <strong>CoreFramework</strong> and <strong>CoreView</strong>
</p>
